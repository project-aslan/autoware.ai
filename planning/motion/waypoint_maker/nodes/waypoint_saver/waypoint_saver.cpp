...
WaypointSaver::WaypointSaver(const ros::NodeHandle& nh, const ros::NodeHandle& private_nh) : nh_(nh), private_nh_(private_nh)
{
  // parameter settings
...
int WaypointSaver::RUN(int argc, char **argv)
{
  ros::spin();
  return 0;
}
